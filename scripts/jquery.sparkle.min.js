...
h,i)},50);else{l=a.extend({},{year:h,month:i},e.ajaxPostData);a.ajax({url:e.ajaxEntriesUrl,method:"post",dataType:"json",data:l,success:function(m){m=m[e.ajaxEntriesVariable]||[];f.setCacheable(h,i,true);if(m.length===0)return true;f.addEntries(m);setTimeout(function(){g(p,h,i)},50);return true},error:function(){window.console.warn("$.EventCalendar.calendarChangeMonthYear.ajax.error:",[this,arguments])}})}else f.isYearMonthEmpty(h,i)||setTimeout(function(){g(p,h,i)},50);return true},k=false,n=function(h,
i,l){if(!k){k=true;a(l).addClass(e.calendarClass);j(h,i,l)}},o=a.extend({},e.datepickerOptions,{onChangeMonthYear:function(h,i,l){j(h,i,l);typeof e.datepickerOptions.onChangeMonthYear==="function"&&n(h,i,l)},beforeShow:function(h,i){datepickerShowed=true;typeof e.datepickerOptions.beforeShow==="function"&&e.datepickerOptions.beforeShow.apply(this,[h,i]);setTimeout(function(){n(i.drawYear,i.drawMonth+1,i)},1E3)}});d.datepicker(o);setTimeout(function(){var h=d.datepicker("getDate");n(h.getFullYear(),
