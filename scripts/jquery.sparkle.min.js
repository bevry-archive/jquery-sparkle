...
(function(a){a(document.body).addClass("js");if(a.Sparkle)window.console.warn("$.Sparkle has already been defined...");else{a.SparkleClass=a.BalClass.clone({addExtension:function(b,c,d){var e=a.Sparkle,f={};switch(true){case d||false:if(typeof b==="string"&&typeof d==="function"&&typeof c==="object"){f.extension=d;f.config=c;f.name=b}if(typeof b==="string"&&typeof c==="function"&&typeof d==="object"){f.extension=c;f.config=d;f.name=b}else throw new Exception("Sparkle.addExtension: Invalid Input");
break;case c||false:if(typeof b==="string"&&typeof c==="function"){f.extension=c;f.name=b}else if(typeof b==="string"&&e.isExtension(c)){f=c;f.name=b}else throw new Exception("Sparkle.addExtension: Invalid Input");break;case b||false:if(e.isExtension(b))f=b;else if(typeof b==="object"||typeof b==="array")a.each(b,function(g,j){e.addExtension(g,j)});else throw new Exception("Sparkle.addExtension: Invalid Input");break}f.config=f.config||{};f.extension=f.extension||{};return true},cycleExtensions:function(){var b=
a.Sparkle,c=b.getExtensions();a.each(c,function(d,e){b.triggerExtension(e)});return true},hasExtension:function(b){return a.Sparkle.getExtension(b)!=="undefined"},isExtension:function(b){return Boolean(b.extension||false)},getExtensions:function(){var b=a.Sparkle,c=b.getConfig(),d={};a.each(c,function(e,f){if(b.isExtension(f))d[e]=f});return d},getExtension:function(b){var c=a.Sparkle,d=undefined;if(c.isExtension(b))d=b;else{b=c.getConfigWithDefault(b);if(c.isExtension(b))d=b}return d},getExtensionConfig:function(b){return a.Sparkle.getExtension(b).config||
{}},applyExtensionConfig:function(b,c){a.Sparkle.applyConfig(b,{config:c});return true},triggerExtension:function(b){var c=a.Sparkle;b=c.getExtension(b);var d=this instanceof jQuery?this:a("body");if(b)return b.extension.apply(d,[c,b.config,b]);return false},fn:function(b){var c=a.Sparkle,d=a(this);b?c.triggerExtension.apply(d,[b]):c.cycleExtensions.apply(d,[]);return d},built:function(){var b=this;a.fn.sparkle=function(c){return b.fn.apply(this,[c])};a(function(){a(document.body).sparkle()});return true}});
a.Sparkle=a.SparkleClass.create({config:{date:{config:{selector:".sparkle-date",datepickerOptions:{},demoText:"Date format must use the international standard: [year-month-day]. This due to other formats being ambigious eg. day/month/year or month/day/year.",demo:'<input type="text" class="sparkle-date" value="2010-08-05" />'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof d.Datepicker==="undefined"){window.console.warn("Datepicker not loaded. Did you forget to include it?");
return false}d.Datepicker(c.datepickerOptions);return true}},time:{config:{selector:".sparkle-time",timepickerOptions:{},demoText:"Time format must be either [hour:minute:second] or [hour:minute], with hours being between 0-23.",demo:'<input type="text" class="sparkle-time" value="23:11" />'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof d.Timepicker==="undefined"){window.console.warn("Timepicker not loaded. Did you forget to include it?");return false}d.Timepicker(c.timepickerOptions);
return true}},datetime:{config:{selector:".sparkle-datetime",datepickerOptions:{},timepickerOptions:{},demoText:"Date format must use the international standard: [year-month-day]. This due to other formats being ambigious eg. day/month/year or month/day/year.<br/>\t\t\t\t\t\t\tTime format must be either [hour:minute:second] or [hour:minute], with hours being between 0-23.",demo:'<input type="text" class="sparkle-datetime" value="2010-08-05 23:10:09" />'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);
if(!d.length)return true;if(typeof d.Datetimepicker==="undefined"){window.console.warn("Datetimepicker not loaded. Did you forget to include it?");return false}d.Datetimepicker({datepickerOptions:b.getExtensionConfig("date").datepickerOptions,timepickerOptions:b.getExtensionConfig("time").timepickerOptions});return true}},"hide-if-empty":{config:{selector:".sparkle-hide-if-empty:empty",demo:'<div class="sparkle-hide-if-empty" style="border:1px solid black"></div>\n<div class="sparkle-hide-if-empty" style="border:1px solid black">Hello World</div>'},
