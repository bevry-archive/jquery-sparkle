...
(function(a){if(a.Datepicker)window.console.warn("$.Datepicker has already been defined...");else a.Datepicker=a.BalClass.create({"default":{useHtml5:false}},{fn:function(b,c){var d=a.Datepicker.getConfigWithDefault(b,c);return a(this).each(function(){var e=a(this);if(e.hasClass("sparkle-date-has"))return this;e.addClass("sparkle-date").addClass("sparkle-date-has");if(d.useHtml5&&Modernizr&&Modernizr.inputtypes.date&&e.attemptTypeChangeTo("date"))return this;e.datepicker(d);return this})},built:function(){var b=
this;a.fn.Datepicker=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
(function(a){if(a.Datetimepicker)window.console.warn("$.Datetimepicker has already been defined...");else a.Datetimepicker=a.BalClass.create({"default":{useHtml5:false,datepickerOptions:{},timepickerOptions:{}},"12hr":{timepickerOptions:{timeConvention:12}},"24hr":{timepickerOptions:{timeConvention:24}}},{fn:function(b,c){var d=a.Datetimepicker.getConfigWithDefault(b,c);return a(this).each(function(){var e=a(this);if(e.hasClass("sparkle-datetime-has"))return this;e.addClass("sparkle-datetime").addClass("sparkle-datetime-has");
...
(function(a){if(a.Timepicker)window.console.warn("$.Timepicker has already been defined...");else a.Timepicker=a.BalClass.create({"default":{useHtml5:false,timeConvention:12},"12hr":{timeConvention:12},"24hr":{timeConvention:24}},{fn:function(b,c){var d=a.Timepicker.getConfigWithDefault(b,c);return a(this).each(function(){var e=a(this);if(e.hasClass("sparkle-time-has"))return this;e.addClass("sparkle-time").addClass("sparkle-time-has");if(d.useHtml5&&Modernizr&&Modernizr.inputtypes.date&&e.attemptTypeChangeTo("time"))return this;
...
[d,b.config,b]);return false},fn:function(b){var c=a(this),d=a.Sparkle;b?d.triggerExtension.apply(c,[b]):d.cycleExtensions.apply(c,[]);return c},built:function(){var b=this;a.fn.sparkle=function(c){return b.fn.apply(this,[c])};a(function(){a(document.body).sparkle()});return true}});a.Sparkle=a.SparkleClass.create({date:{config:{selector:".sparkle-date",datepickerOptions:{},demoText:"Date format must use the international standard: [year-month-day]. This due to other formats being ambigious eg. day/month/year or month/day/year.",
demo:'<input type="text" class="sparkle-date" value="2010-08-05" />'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof d.Datepicker==="undefined"){window.console.warn("Datepicker not loaded. Did you forget to include it?");return false}d.Datepicker(c.datepickerOptions);return true}},time:{config:{selector:".sparkle-time",timepickerOptions:{},demoText:"Time format must be either [hour:minute:second] or [hour:minute], with hours being between 0-23.",demo:'<input type="text" class="sparkle-time" value="23:11" />'},
extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof d.Timepicker==="undefined"){window.console.warn("Timepicker not loaded. Did you forget to include it?");return false}d.Timepicker(c.timepickerOptions);return true}},datetime:{config:{selector:".sparkle-datetime",datepickerOptions:{},timepickerOptions:{},demoText:"Date format must use the international standard: [year-month-day]. This due to other formats being ambigious eg. day/month/year or month/day/year.<br/>\t\t\t\t\t\t\tTime format must be either [hour:minute:second] or [hour:minute], with hours being between 0-23.",
