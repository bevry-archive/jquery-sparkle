...
true;else{if(typeof window.console.trace==="undefined")window.console.trace=function(){window.console.error("console.trace does not exist")};window.console.hasTrace=false}window.console.emulated=true}Date.prototype.setDatetimestr=Date.prototype.setDatetimestr||function(a){a=a.split(/[\-\s\:]/g);var b=a[3]||0,c=a[4]||0,d=a[5]||0;this.setUTCFullYear(a[0],a[1]-1,a[2]);this.setUTCHours(b);this.setUTCMinutes(c);this.setUTCSeconds(d);return this};
...
this;c.call(e);var f=a(e);f.data("lastclick-clicks",(f.data("lastclick-clicks")||0)+1);var g=setTimeout(function(){var i=f.data("lastclick-clicks");c.apply(e,[d]);f.data("lastclick-clicks",0);d.type="lastclick";a.event.handle.apply(e,[d,i])},500);f.data("lastclick-timeout",g)}).apply(this,[b])}};a.fn.firstclick=a.fn.firstclick||function(b,c){return a(this).binder("firstclick",b,c)};a.event.special.firstclick=a.event.special.firstclick||{setup:function(){a(this).bind("click",a.event.special.firstclick.handler)},
...
c.call(e);var f=a(e);f.data("singleclick-clicks",(f.data("singleclick-clicks")||0)+1);var g=setTimeout(function(){var i=f.data("singleclick-clicks");c.apply(e,[d]);f.data("singleclick-clicks",0);if(i===1){d.type="singleclick";a.event.handle.apply(e,[d])}},500);f.data("singleclick-timeout",g)}).apply(this,[b])}}})(jQuery);
...
b[1];b[1]="$.intercept.skipValue"}}else{c=b[0];b[0]="$.intercept.skipValue"}var f={};a.each(c,function(g){f[g]=true});d?a.each(b,function(g,i){if(i==="$.intercept.skipValue")return true;a.each(i,function(k,l){if(typeof f[k]==="undefined")return true;if(typeof l==="object"&&!(l.test||0))a.extend(c[k],l||{});else c[k]=l})}):a.each(b,function(g,i){a.each(i,function(k,l){if(typeof f[k]==="undefined")return true;if(typeof l==="object"&&!(l.test||0))a.intercept(true,c[k],l);else c[k]=l})});return c};a.promise=
a.promise||function(b){var c=b.object||this;if(typeof c[b.handlers]==="undefined")c[b.handlers]=[];if(typeof c[b.flag]==="undefined")c[b.flag]=false;var d=c[b.handlers],e=c[b.flag],f=b.arguments[0];switch(typeof f){case "boolean":e=c[b.flag]=f;case "undefined":if(e&&d.length){a.each(d,function(g,i){i.call(c)});c[b.handlers]=[]}break;case "function":e?f.call(c):c[b.handlers].push(f);break;default:window.console.error("Unknown arguments for $.promise",[this,arguments])}return e}})(jQuery);
...
d.strengthCss.medium,d.strengthCss.high,d.strengthCss.empty].join(" "),i=a(d.password),k=a(d.confirm||null),l=a(d.username||null);c=function(){var o=i.val(),h=k.val(),j=l.val();h=o?o.passwordstrength(h,j):"empty";o=d.strengthCss[h];h=d.il8n[h];f.removeClass(g).addClass(o).html(h)};i.keyup(function(){var o=a(this);k.val("");o.val()!==""&&!e.data("shown")&&e.animate({height:"show",opacity:"show"},"slow").data("shown",true)});i.add(k).add(l).keyup(c);c();return b}})(jQuery);
(function(a){if(a.BalClass)window.console.warn("$.BalClass has already been defined...");else{a.BalClass=function(b){this.construct(b)};a.extend(a.BalClass.prototype,{config:{},construct:function(b,c){var d={};if(typeof b==="object"&&typeof c==="object"){d=c;d.config=b||{}}else if(typeof b==="object"){d=b;d.config=d.config||{}}else if(typeof b==="undefined")d=false;else window.console.error("BalClass.construct: Invalid Input");if(d!==false){this.configure(d.config);delete d.config;a.extend(this,d)}if(typeof this.built===
"function")return this.built();return true},configure:function(b){this.config=this.config||{};this.config=a.extend({},this.config,b||{});return this},clone:function(b){var c=function(d){this.construct(d)};a.extend(c.prototype,this.prototype,b||{});c.clone=c.prototype.clone;c.create=c.prototype.create;return c},create:function(b){return new this(b)},addConfig:function(b,c){var d=this;if(typeof c==="undefined"){typeof b==="object"&&a.each(b,function(e,f){d.applyConfig(e,f)});return false}else typeof c===
"object"&&d.applyConfig(b,c);return d},applyConfig:function(b,c){this.config[b]=this.config[b]||{};a.extend(true,this.config[b],c||{});return this},setConfig:function(b,c){this.config[b]=c||{};return this},hasConfig:function(b){return typeof this.config[b]!=="undefined"},getConfig:function(b){if(typeof b!=="string")return this.config;return this.getConfigWith(b)},getConfigWith:function(b,c){if(typeof b!=="string"){if(typeof c==="undefined")c=b;b="default"}if(typeof c!=="object")c={};var d={};a.extend(true,
d,this.config[b]||{},c||{});return d},getConfigWithDefault:function(b,c){return this.getConfigWith("default",this.getConfigWith(b,c))},setDefaults:function(b){return this.applyConfig("default",b)}});a.BalClass.clone=a.BalClass.prototype.clone;a.BalClass.create=a.BalClass.prototype.create}})(jQuery);
(function(a){if(a.Bespin)window.console.warn("$.Bespin has already been defined...");else a.Bespin=a.BalClass.create({config:{"default":{content:null,bespin:{settings:{tabstop:4}},toolbar:{fullscreen:true}},rich:{bespin:{syntax:"html"}},html:{bespin:{syntax:"html"}},plain:{toolbar:false}},fn:function(b,c){var d=a.Bespin,e=d.getConfigWithDefault(b,c),f=this,g=function(){d.useBespin(f,e);a(window).unbind("onBespinLoad",g)};a(window).bind("onBespinLoad",g);var i={onBespinLoad:function(){a(window).trigger("onBespinLoad")}};
if(bespin.bootLoaded)setTimeout(function(){i.onBespinLoad()},500);else window.onBespinLoad=i.onBespinLoad;return this},useBespin:function(b,c){var d=a.Bespin,e=a(b),f,g;if(e.is("textarea")){g=e.attr("id")+"-bespin";f=a('<div id="'+g+'"/>').html(e.val()).css({height:e.css("height"),width:e.css("width")});f.insertAfter(e);e.hide()}else{f=e;g=f.attr("id")}bespin.useBespin(g,c.bespin).then(function(i){d.postBespin(g,i,c)},function(i){window.console.error("Bespin Launch Failed: "+i)});return this},postBespin:function(b,
c,d){b=a("#"+b);var e=b.siblings("textarea"),f=c.editor;b.css("overflow","hidden");b.wrap('<div class="bespin-wrap" />');b.parent();e.length&&e.parents("form:first").submit(function(){e.val(f.value)});if(d.content||d.content==="")f.value=d.content;return this},built:function(){var b=this;a.fn.Bespin=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
...
if(d.useHtml5&&Modernizr&&Modernizr.inputtypes.datetime&&e.attemptTypeChangeTo("datetime"))return this;var f=e.val(),g=new Date,i="",k="";if(f){g.setDatetimestr(f);i=g.getDatestr();k=g.getTimestr()}e.hide();var l=a('<input type="text" class="sparkle-date"/>');f=a('<span class="sparkle-datetime-sep"> @ </span>');var o=a('<input type="text" class="sparkle-time"/>');o.insertAfter(e);f.insertAfter(e);l.insertAfter(e);l.val(i);o.val(k);l.add(o).change(function(){var h=l.val()+" "+o.val();e.val(h).trigger("change")});
...
c),f={entriesById:{},entriesByYearMonth:{},cacheableByYearMonth:{},isCacheable:function(h,j){return this.cacheableByYearMonth[h+"-"+j]?true:false},setCacheable:function(h,j,m){if(typeof m==="undefined")this.cacheableByYearMonth[h+"-"+j]=m;return this},isYearMonthSet:function(h,j){return typeof this.entriesByYearMonth[h+"-"+j]!=="undefined"},isYearMonthEmpty:function(h,j){return!(typeof this.entriesByYearMonth[h+"-"+j]==="array"&&this.entriesByYearMonth[h+"-"+j].length!==0||typeof this.entriesByYearMonth[h+
"-"+j]==="object"&&!a.isEmptyObject(this.entriesByYearMonth[h+"-"+j]))},getEntriesByYearMonth:function(h,j){return this.entriesByYearMonth[h+"-"+j]||[]},getEntryById:function(h){return this.entriesById[h]||undefined},getDaysInMonth:function(h){return 32-(new Date(h.getFullYear(),h.getMonth(),32)).getDate()},getDate:function(h){var j;if(typeof h==="string")j=new Date(h);else if(typeof h==="number"){j=new Date;j.setTime(h)}else if(typeof h==="object"){j=new Date;j.setTime(h.getTime())}else throw Error("Unknown date format.");
if(isNaN(j)||j.toString()==="Invalid Date"){j=new Date;j.setDatetimestr(h)}return j},addEntries:function(h){var j=this;a.each(h,function(m,n){n.id=n.id||m;j.addEntry(n)});return true},addEntry:function(h){h.start=this.getDate(h.start);h.finish=this.getDate(h.finish);var j=this.getDate(h.start);j.setDate(1);j.setHours(0);j.setMinutes(0);j.setSeconds(0);j.setMilliseconds(0);var m=this.getDate(h.finish);m.setDate(2);m.setHours(0);m.setMinutes(0);m.setSeconds(0);for(m.setMilliseconds(0);j<m;){var n=j.getFullYear(),
p=j.getMonth()+1;if(typeof this.entriesByYearMonth[n+"-"+p]==="undefined")this.entriesByYearMonth[n+"-"+p]={};this.entriesByYearMonth[n+"-"+p][h.id]=h;if(p===11){j.setMonth(0);j.setYear(n+1)}else j.setMonth(p+1)}return this.entriesById[h.id]=h}};f.addEntries(e.calendarEntries);var g=function(h,j,m){var n=f.getEntriesByYearMonth(j,m),p=a(h).find("tbody td"),q=p.find("a");if(e.disableClick){p.unbind("click").removeAttr("onclick");q.removeAttr("href").css("cursor","default")}a.each(n,function(J,s){var t=
...
r.push(s.id);r=r.join(",")}x.data("dayEntriesIds",r);a.each(e.domEvents,function(A,F){x.unbind(A).bind(A,function(G){var y=a(this),B=y.text().trim();y=String(y.data("dayEntriesIds")).split(/,/g);var C=new Date;C.setDatestr(j+"-"+m+"-"+B);var D=[];a.each(y,function(L,H){var I=f.getEntryById(H);D.push(I)});F.apply(this,[G,{year:j,month:m,day:B,date:C,dayEntries:D,monthEntries:n,datepicker:h}]);return true})})})});return true},i=function(h,j,m){var n=m.dpDiv||m;if(typeof e.ajaxEntriesUrl==="string"&&
e.ajaxEntriesUrl.length)if(e.ajaxCache&&f.isCacheable(h,j)&&!f.isYearMonthEmpty(h,j))setTimeout(function(){g(n,h,j)},50);else{m=a.extend({},{year:h,month:j},e.ajaxPostData);a.ajax({url:e.ajaxEntriesUrl,method:"post",dataType:"json",data:m,success:function(p){p=p[e.ajaxEntriesVariable]||[];f.setCacheable(h,j,true);if(p.length===0)return true;f.addEntries(p);setTimeout(function(){g(n,h,j)},50);return true},error:function(){window.console.warn("$.EventCalendar.calendarChangeMonthYear.ajax.error:",[this,
arguments])}})}else f.isYearMonthEmpty(h,j)||setTimeout(function(){g(n,h,j)},50);return true},k=false,l=function(h,j,m){if(!k){k=true;a(m).addClass(e.calendarClass);i(h,j,m)}},o=a.extend({},e.datepickerOptions,{onChangeMonthYear:function(h,j,m){i(h,j,m);typeof e.datepickerOptions.onChangeMonthYear==="function"&&l(h,j,m)},beforeShow:function(h,j){datepickerShowed=true;typeof e.datepickerOptions.beforeShow==="function"&&e.datepickerOptions.beforeShow.apply(this,[h,j]);setTimeout(function(){l(j.drawYear,
j.drawMonth+1,j)},1E3)}});d.datepicker(o);setTimeout(function(){var h=d.datepicker("getDate");l(h.getFullYear(),h.getMonth()+1,d)},2E3);return d},built:function(){var b=this;a.fn.EventCalendar=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
...
var f=e.val(),g=new Date,i=d.timeConvention,k=12,l=0,o="am";if(f){g.setTimestr(f);k=g.getUTCHours();l=g.getUTCMinutes()}if(i===12&&k>12){o="pm";k-=12}l=l.roundTo(5);if(i===12){if(k>12||k<1){k=1;window.console.warn("timepicker.fn: Invalid Hours.",[this,arguments])}}else if(k>23||k<0){k=1;window.console.warn("timepicker.fn: Invalid Hours.",[this,arguments])}if(l>60||l<0){l=0;window.console.warn("timepicker.fn: Invalid Minutes.",[this,arguments])}e.hide();if(i===12){var h=a('<select class="sparkle-time-meridian" />');
h.append("<option>am</option>");h.append("<option>pm</option>");h.val(o).insertAfter(e)}var j=a('<select class="sparkle-time-minutes" />');for(k=0;k<=55;k+=5)j.append('<option value="'+k+'">'+k.padLeft("0",2)+"</option>");j.val(l).insertAfter(e);var m=a('<select class="sparkle-time-hours" />');if(i===12){k=i;for(l=1;l<=k;++l)m.append('<option value="'+l+'">'+l.padLeft("0",2)+"</option>");m.val(k-1).insertAfter(e)}else{k=i;for(l=0;l<k;++l)m.append('<option value="'+l+'">'+l.padLeft("0",2)+"</option>");
m.val(k).insertAfter(e)}k=function(){var n=parseInt(m.val(),10),p=j.val();if(i===12){var q=h.val();if(n!==12&&q==="pm")n+=12;if(n===12&&q==="am")n=0}n=n.padLeft(0,2)+":"+p.padLeft(0,2)+":00";e.val(n).trigger("change")};m.add(j).add(h).change(k);e.parent("form:first").submit(k);return e})},built:function(){var b=this;a.fn.timepicker=a.fn.Timepicker=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
...
(function(a){a(document.body).addClass("js");if(a.Sparkle)window.console.warn("$.Sparkle has already been defined...");else{a.SparkleClass=a.BalClass.clone({addExtensions:function(){var b=this.addExtension.apply(this,arguments);this.onConfigured(true);return b},addExtension:function(b,c,d){var e=this,f={};switch(true){case Boolean(d||false):if(typeof b==="string"&&typeof d==="function"&&typeof c==="object"){f.extension=d;f.config=c;f.name=b}if(typeof b==="string"&&typeof c==="function"&&typeof d===
"object"){f.extension=c;f.config=d;f.name=b}else window.console.error("Sparkle.addExtension: Invalid Input");break;case Boolean(c||false):if(typeof b==="string"&&typeof c==="function"){f.extension=c;f.name=b}else if(typeof b==="string"&&e.isExtension(c)){f=c;f.name=b}else window.console.error("Sparkle.addExtension: Invalid Input");break;case Boolean(b||false):if(e.isExtension(b))f=b;else if(typeof b==="object"||typeof b==="array"){a.each(b,function(g,i){e.addExtension(g,i)});return this}else window.console.error("Sparkle.addExtension: Invalid Input")}f.config=
f.config||{};f.extension=f.extension||{};e.addConfig(f.name,f);e.onReady(function(){e.triggerExtension(a("body"),f)});return this},hasExtension:function(b){return this.getExtension(b)!=="undefined"},isExtension:function(b){return Boolean(b&&(b.extension||false))},getExtensions:function(){var b=this,c=b.getConfig(),d={};a.each(c,function(e,f){if(b.isExtension(f))d[e]=f});return d},getExtension:function(b){var c=undefined;if(this.isExtension(b))c=b;else{b=this.getConfigWithDefault(b);if(this.isExtension(b))c=
b}return c},getExtensionConfig:function(b){Extension=this.getExtension(b);return Extension.config||{}},applyExtensionConfig:function(b,c){this.applyConfig(b,{config:c});return this},triggerExtensions:function(b){var c=this,d=c.getExtensions();a.each(d,function(e,f){c.triggerExtension(b,f)});return this},triggerExtension:function(b,c){var d=this.getExtension(c);b=b instanceof jQuery?b:a("body");if(d)return d.extension.apply(b,[this,d.config,d]);else window.console.error("Sparkle.triggerExtension: Could not find the extension.",
[this,arguments],[c,d]);return this},fn:function(b,c){var d=a(this);c?b.triggerExtension.apply(b,[d,c]):b.triggerExtensions.apply(b,[d]);return this},built:function(){var b=this;a.fn.sparkle=function(c){return b.fn.apply(this,[b,c])};a(function(){b.onDocumentReady(true)});b.onConfigured(function(){b.onDocumentReady(function(){b.onReady(true)})});return true},onConfigured:function(){return a.promise({object:this,handlers:"onConfiguredHandlers",flag:"isConfigured",arguments:arguments})},onDocumentReady:function(){return a.promise({object:this,
handlers:"onDocumentReadyHandlers",flag:"isDocumentReady",arguments:arguments})},onReady:function(){return a.promise({object:this,handlers:"onReadyHandlers",flag:"isReady",arguments:arguments})}});a.Sparkle=a.SparkleClass.create().addExtensions({date:{config:{selector:".sparkle-date",datepickerOptions:{},demoText:"Date format must use the international standard: [year-month-day]. This due to other formats being ambigious eg. day/month/year or month/day/year.",demo:'<input type="text" class="sparkle-date" value="2010-08-05" />'},
...
d.once("click",{clickEvent:function(e){if(typeof GSFN_feedback_widget==="undefined"){window.console.warn("GSFN not loaded. Did you forget to include it?");return true}GSFN_feedback_widget.show();e.preventDefault();return false}}.clickEvent);return true}},hint:{config:{selector:".form-input-tip,.sparkle-hint,.sparkle-hint-has,:text[placeholder]",hasClass:"sparkle-hint-has",hintedClass:"sparkle-hint-hinted",demoText:"Simulates HTML5's <code>placeholder</code> attribute for non HTML5 browsers. Placeholder can be the <code>title</code> or <code>placeholder</code> attribute. Placeholder will not be sent with the form (unlike most other solutions). The <code>sparkle-hint</code> class is optional if you are using the <code>placeholder</code> attribute.",
demo:'<input type="text" class="sparkle-hint" placeholder="This is some hint text." title="This is a title." /><br/>\n<input type="text" class="sparkle-hint" title="This is some hint text." />'},extension:function(b,c){var d=a(this),e=d.findAndSelf(c.selector).addClass(c.hasClass);if(!e.length)return true;var f={focusEvent:function(){var g=a(this),i=g.attr("placeholder")||g.attr("title"),k=g.val();i===k&&g.val("").removeClass(c.hintedClass);return true},blurEvent:function(){var g=a(this),i=g.attr("placeholder")||
g.attr("title"),k=g.val();if(i===k||!k)g.val("").addClass(c.hintedClass).val(i);return true},submitEvent:function(){e.trigger("focus")}};if(typeof Modernizr!=="undefined"&&Modernizr.input.placeholder)e.each(function(){var g=a(this),i=g.attr("title");i&&!g.attr("placeholder")&&g.attr("placeholder",i)});else{e.each(function(){a(this).once("focus",f.focusEvent).once("blur",f.blurEvent).trigger("blur")});d.find("form").once("submit",f.submitEvent)}return d}},debug:{config:{selector:".sparkle-debug",hasClass:"sparkle-debug-has",
hintedClass:"sparkle-debug-hinted",showVar:"sparkle-debug-show",demo:""},extension:function(b,c){var d=a(this),e=d.findAndSelf(c.selector);if(!e.length)return true;e.addClass(c.hasClass).find(".value:has(.var)").hide().siblings(".name,.type").addClass("link").once("singleclick",f.clickEvent).once("dblclick",f.dblclickEvent);var f={clickEvent:function(){var g=a(this),i=g.parent(),k=!i.data(c.showVar);i.data(c.showVar,k);g.siblings(".value").toggle(k)},dblclickEvent:function(){var g=a(this).parent(),
i=g.data(c.showVar);g.data(c.showVar,i);g.find(".value").toggle(i)}};return d}},submit:{config:{selector:".sparkle-submit",demoText:"Adding the <code>sparkle-submit</code> class to an element within a <code>form</code> will submit the form when that element is clicked."},extension:function(b,c){var d=a(this),e=d.findAndSelf(c.selector);if(!e.length)return true;e.once("singleclick",{clickEvent:function(){a(this).submitForm();return true}}.clickEvent);return d}},submitswap:{config:{selector:".sparkle-submitswap",
demoText:"Adding the <code>sparkle-submitswap</code> class to a submit button, will swap it's value with it's title when it has been clicked. Making it possible for a submit value which isn't the submit button's text."},extension:function(b,c){var d=a(this),e=d.findAndSelf(c.selector);if(!e.length)return true;e.once("singleclick",{clickEvent:function(){var f=a(this);f.val(f.data("sparkle-submitswap-value"));return true}}.clickEvent);e.each(function(){var f=a(this);f.data("sparkle-submitswap-value",
...
extension:function(b,c){var d=a(this),e=d.findAndSelf(c.selector);if(!e.length)return true;e.findAndSelf(c.innerSelector).each(function(){var f=a(this),g=f.text().trim();c.empty.has(g)?f.addClass(c.emptyClass):f.addClass(c.notemptyClass)});return d}},demo:{config:{selector:".sparkle-demo",hasClass:"sparkle-debug-has",demoText:"Adding the <code>sparkle-demo</code> will display all these demo examples used on this page."},extension:function(b,c){var d=a(this),e=d.findAndSelf(c.selector);if(e.hasClass(c.hasClass)||
!e.length)return true;e.addClass(c.hasClass);var f=b.getExtensions();a.each(f,function(g,i){var k=i.config.demo||"",l=i.config.demoText||"";if(!k&&!l)return true;var o=a('<div class="sparkle-demo-section" id="sparkle-demo-'+g+'">\t\t\t\t\t\t\t\t<h3>'+g+"</h3>\t\t\t\t\t\t\t</div>");l&&o.append('<div class="sparkle-demo-text">'+l+"</div>");if(k){l=k.replace(/</g,"&lt;").replace(/>/g,"&gt;");o.append('<h4>Example Code:</h4>\t\t\t\t\t\t\t\t<pre class="code language-html sparkle-demo-code">'+l+'</pre>\t\t\t\t\t\t\t\t<h4>Example Result:</h4>\t\t\t\t\t\t\t\t<div class="sparkle-demo-result">'+
k+"</div>")}o.appendTo(e)});e.sparkle();return d}}})}})(jQuery);
