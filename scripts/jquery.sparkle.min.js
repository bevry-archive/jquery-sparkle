...
a.promise||function(b){var c=b.object||this;if(typeof c[b.handlers]==="undefined")c[b.handlers]=[];if(typeof c[b.flag]==="undefined")c[b.flag]=false;var d=c[b.handlers],e=c[b.flag],f=b.arguments[0];switch(typeof f){case "boolean":e=c[b.flag]=f;case "undefined":if(e&&d.length){a.each(d,function(g,i){i.call(c)});c[b.handlers]=[]}break;case "function":e?f.call(c):c[b.handlers].push(f);break;default:window.console.error("Unknown arguments for $.promise",[this,arguments]);break}return e}})(jQuery);
...
500);else window.onBespinLoad=g.onBespinLoad;return this},useBespin:function(b,c){var d=a.Bespin,e=a(b),f,g;if(e.is("textarea")){g=e.attr("id")+"-bespin";f=a('<div id="'+g+'"/>').html(e.val()).css({height:e.css("height"),width:e.css("width")});f.insertAfter(e);e.hide()}else{f=e;g=f.attr("id")}bespin.useBespin(g,c.bespin).then(function(i){d.postBespin(g,i,c)},function(i){window.console.error("Bespin Launch Failed: "+i)});return this},postBespin:function(b,c,d){var e=a("#"+b),f=e.siblings("textarea"),
g=c.editor;e.css("overflow","hidden");e.wrap('<div class="bespin-wrap" />');var i=e.parent();f.length&&f.parents("form:first").submit(function(){f.val(g.value)});if(d.content||d.content==="")g.value=d.content;if(d.toolbar){b=a('<div class="bespin-toolbar" />');b.insertBefore(e);if(d.toolbar.fullscreen){d=a('<span class="bespin-toolbar-fullscreen" title="Toggle Fullscreen"></span>');d.appendTo(b);d.click(function(){i.hasClass("bespin-fullscreen")?a("body").add(i).removeClass("bespin-fullscreen"):a("body").add(i).addClass("bespin-fullscreen");
