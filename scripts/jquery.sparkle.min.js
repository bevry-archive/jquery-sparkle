...
a.fn.highlight||function(b){return a(this).effect("highlight",{},b||3E3)};a.fn.htmlAndSelf=a.fn.htmlAndSelf||function(){return a(this).attr("outerHTML")};a.fn.attemptTypeChangeTo=a.fn.attemptTypeChangeTo||function(b){var c=a(this),d=false,e=c.get(0),f=e.type;if(b===f)d=true;else if(c.is("input"))if(!a.browser.msie){e.type=b;if(e.type!==f)d=true}return d}})(jQuery);
