...
Number.prototype.roundTo=String.prototype.roundTo=String.prototype.roundTo||function(){var a=String(parseInt(this,10));return a=parseInt(a.replace(/[1,2]$/,0).replace(/[3,4]$/,5),10)};String.prototype.trim=String.prototype.trim||function(){return this.replace(/^\s+|\s+$/g,"")};String.prototype.strip=String.prototype.strip||function(a){a=String(a);a=this.replace(eval("/^"+a+"+|"+a+"+$/g"),"");return String(a)};
String.prototype.stripLeft=String.prototype.stripLeft||function(a){a=String(a);a=this.replace(eval("/^"+a+"+/g"),"");return String(a)};String.prototype.stripRight=String.prototype.stripRight||function(a){a=String(a);a=this.replace(eval("/"+a+"+$/g"),"");return String(a)};String.prototype.toInt=String.prototype.toInt||function(){return parseInt(this,10)};String.prototype.wrap=String.prototype.wrap||function(a,b){return a+this+b};
...
d.strengthCss.medium,d.strengthCss.high,d.strengthCss.empty].join(" "),j=a(d.password),k=a(d.confirm||null),o=a(d.username||null);c=function(){var p=j.val(),h=k.val(),i=o.val();h=p?p.passwordstrength(h,i):"empty";p=d.strengthCss[h];h=d.il8n[h];f.removeClass(g).addClass(p).html(h)};j.keyup(function(){var p=a(this);k.val("");p.val()!==""&&!e.data("shown")&&e.animate({height:"show",opacity:"show"},"slow").data("shown",true)});j.add(k).add(o).keyup(c);c();return b}})(jQuery);
...
(function(a){if(a.Bespin)console.warn("$.Bespin has already been defined...");else a.Bespin=a.BalClass.create({"default":{content:null,bespin:{settings:{tabstop:4}},toolbar:{fullscreen:true}},rich:{bespin:{syntax:"html"}},html:{bespin:{syntax:"html"}},plain:{toolbar:false}},{fn:function(b,c){var d=a.Bespin,e=d.getConfigWithDefault(b,c),f=this;a(window).bind("onBespinLoad",function(){d.useBespin(f,e)});var g={onBespinLoad:function(){a(window).trigger("onBespinLoad")}};if(bespin.bootLoaded)setTimeout(function(){g.onBespinLoad()},
...
b.css("overflow","hidden");b.wrap('<div class="bespin-wrap" />');var g=b.parent();e.length&&e.parents("form:first").submit(function(){e.val(f.value)});if(d.content||d.content==="")f.value=d.content;if(d.toolbar){$toolbar=a('<div class="bespin-toolbar" />');$toolbar.insertBefore(b);if(d.toolbar.fullscreen){$fullscreen=a('<span class="bespin-toolbar-fullscreen" title="Toggle Fullscreen"></span>');$fullscreen.appendTo($toolbar);$fullscreen.click(function(){g.hasClass("bespin-fullscreen")?a("body").add(g).removeClass("bespin-fullscreen"):
a("body").add(g).addClass("bespin-fullscreen");c.dimensionsChanged()})}}return this},built:function(){var b=this;a.fn.Bespin=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
...
var f=a('<input type="text" class="sparkle-date"/>'),g=a('<span class="sparkle-datetime-sep"> @ </span>'),j=a('<input type="text" class="sparkle-time"/>'),k=e.val(),o=new Date,p="",h="";if(k){o.setDatetimestr(k);p=o.getDatestr();h=o.getTimestr()}j.insertAfter(e);g.insertAfter(e);f.insertAfter(e);f.val(p);j.val(h);f.add(j).change(function(){var i=f.val()+" "+j.val();e.val(i).trigger("change")});f.datepicker(d.datepickerOptions);j.timepicker(d.timepickerOptions);return e})},built:function(){var b=this;
a.fn.datetimepicker=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
(function(a){if(a.EventCalendar)console.warn("$.EventCalendar has already been defined...");else a.EventCalendar=a.BalClass.create({"default":{ajaxEntriesVariable:"entries",ajaxEntriesUrl:"",ajaxPostData:{},ajaxCache:true,calendarEntries:[],calendarClass:"hasEventCalendar",dayEventClass:"ui-state-active hasEvent",datepickerOptions:{},disableClick:true,domEvents:{}}},{fn:function(b,c){var d=a(this);if(d.length>1){d.each(function(){a(this).EventCalendar(b,c)});return this}var e=a.Bespin.getConfigWithDefault(b,
...
if(isNaN(i)||i.toString()==="Invalid Date"){i=new Date;i.setDatetimestr(h)}return i},addEntries:function(h){var i=this;a.each(h,function(l,n){n.id=n.id||l;i.addEntry(n)});return true},addEntry:function(h){h.start=this.getDate(h.start);h.finish=this.getDate(h.finish);var i=this.getDate(h.start);i.setDate(1);i.setHours(0);i.setMinutes(0);i.setSeconds(0);i.setMilliseconds(0);var l=this.getDate(h.finish);l.setDate(2);l.setHours(0);l.setMinutes(0);l.setSeconds(0);for(l.setMilliseconds(0);i<l;){var n=i.getFullYear(),
m=i.getMonth()+1;if(typeof this.entriesByYearMonth[n+"-"+m]==="undefined")this.entriesByYearMonth[n+"-"+m]={};this.entriesByYearMonth[n+"-"+m][h.id]=h;if(m===11){i.setMonth(0);i.setYear(n+1)}else i.setMonth(m+1)}return this.entriesById[h.id]=h}};f.addEntries(e.calendarEntries);var g=function(h,i,l){var n=f.getEntriesByYearMonth(i,l);h=a(h).find("tbody td");var m=h.find("a");if(e.disableClick){h.unbind("click").removeAttr("onclick");m.removeAttr("href").css("cursor","default")}a.each(n,function(H,
...
String(q).split(/,/g);q.push(r.id);q=q.join(",")}w.data("dayEntriesIds",q);a.each(e.domEvents,function(z,C){w.unbind(z).bind(z,function(D){var x=a(this),E=x.text().trim();x=String(x.data("dayEntriesIds")).split(/,/g);var A=[];a.each(x,function(J,F){var G=f.getEntryById(F);A.push(G)});C.apply(this,[D,E,A,n]);return true})})})});return true},j=function(h,i,l){var n=l.dpDiv||l;if(typeof e.ajaxEntriesUrl==="string"&&e.ajaxEntriesUrl.length)if(e.ajaxCache&&f.isCacheable(h,i)&&!f.isYearMonthEmpty(h,i))setTimeout(function(){g(n,
h,i)},50);else{l=a.extend({},{year:h,month:i},e.ajaxPostData);a.ajax({url:e.ajaxEntriesUrl,method:"post",dataType:"json",data:l,success:function(m){m=m[e.ajaxEntriesVariable]||[];f.setCacheable(h,i,true);if(m.length===0)return true;f.addEntries(m);setTimeout(function(){g(n,h,i)},50);return true}})}else f.isYearMonthEmpty(h,i)||setTimeout(function(){g(n,h,i)},50);return true},k=false,o=function(h,i,l){if(!k){k=true;a(l).addClass(e.calendarClass);j(h,i,l)}},p=a.extend({},e.datepickerOptions,{onChangeMonthYear:function(h,
i,l){j(h,i,l);typeof e.datepickerOptions.onChangeMonthYear==="function"&&o(h,i,l)},beforeShow:function(h,i){datepickerShowed=true;typeof e.datepickerOptions.beforeShow==="function"&&e.datepickerOptions.beforeShow.apply(this,[h,i]);setTimeout(function(){o(i.drawYear,i.drawMonth+1,i)},1E3)}});d.datepicker(p);setTimeout(function(){var h=d.datepicker("getDate");o(h.getFullYear(),h.getMonth()+1,d)},2E3);return d},built:function(){var b=this;a.fn.EventCalendar=function(c,d){return b.fn.apply(this,[c,d])};
return true}})})(jQuery);
(function(a){if(a.Help)console.warn("$.Help has already been defined...");else a.Help=a.BalClass.create({"default":{wrap:'<span class="sparkle-help-wrap"/>',icon:'<span class="sparkle-help-icon"/>',text:'<span class="sparkle-help-text"/>',parentClass:"",title:""}},{fn:function(b){var c=a.Help;if(typeof b==="string")b={title:b};b=c.getConfigWithDefault("default",b);c=a(this);var d=a(b.wrap),e=a(b.icon),f=a(b.text);c.parent().addClass(b.parentClass);var g=c.contents();c.append(d.append(f).append(e));g.appendTo(f);
c.attr("title",b.title);return c},built:function(){var b=this;a.fn.help=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
...
g+'">'+g.padLeft("0",2)+"</option>");var j=a('<select class="sparkle-time-minutes" />');for(f=0;f<=55;f+=5)j.append('<option value="'+f+'">'+f.padLeft("0",2)+"</option>");var k=a('<select class="sparkle-time-meridian" />');k.append("<option>am</option>");k.append("<option>pm</option>");g=d.val();var o=new Date;f="12";var p="0",h="am";if(g){o.setTimestr(g);f=o.getUTCHours();p=o.getUTCMinutes();if(f>12){f-=12;h="pm"}}k.insertAfter(d);j.insertAfter(d);e.insertAfter(d);if(f>12&&h=="pm")f-=12;e.val(f);
j.val(p.roundTo(5));k.val(h);f=function(){var i=parseInt(e.val(),10),l=j.val();if(k.val()=="pm")i+=12;if(i>=24)i=0;i=i.padLeft(0,2)+":"+l.padLeft(0,2)+":00";d.val(i).trigger("change")};e.add(j).add(k).change(f);d.parent("form:first").submit(f);return d})},built:function(){var b=this;a.fn.timepicker=function(c,d){return b.fn.apply(this,[c,d])};return true}})})(jQuery);
...
if(typeof d.timepicker==="undefined"){console.warn("datepicker not loaded. Did you forget to include it?");return false}d.datepicker(c.datepickerOptions);return true}},time:{config:{selector:".sparkle-time",timepickerOptions:{},demo:'<input type="text" class="sparkle-time" />'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof d.timepicker==="undefined"){console.warn("timepicker not loaded. Did you forget to include it?");return false}d.timepicker(c.timepickerOptions);
return true}},datetime:{config:{selector:".sparkle-datetime",datepickerOptions:{},timepickerOptions:{},demo:'<input type="text" class="sparkle-datetime" />'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof d.datetimepicker==="undefined"){console.warn("datetimepicker not loaded. Did you forget to include it?");return false}d.datetimepicker({datepickerOptions:b.getExtensionConfig("date").datepickerOptions,timepickerOptions:b.getExtensionConfig("time").timepickerOptions});
...
demo:'<textarea class="autogrow">This textarea will autogrow with your input. - Only if jQuery Autogrow has been loaded.</textarea>'},extension:function(b,c){var d=a(this).findAndSelf(c.selector);if(!d.length)return true;if(typeof a.fn.autogrow==="undefined"){console.warn("autogrow not loaded. Did you forget to include it?");return false}d.autogrow();return true}},gsfnwidget:{config:{selector:".gsfnwidget",demo:'<a class="gsfnwidget" href="#">This link will show a GetSatisfaction Widget onclick. - Only if GetSatisfaction has been loaded.</a>'},
extension:function(b,c){var d={clickEvent:function(f){if(typeof GSFN_feedback_widget==="undefined"){console.warn("GSFN not loaded. Did you forget to include it?");return true}GSFN_feedback_widget.show();f.preventDefault();return false}},e=a(this).findAndSelf(c.selector);if(!e.length)return true;e.once("click",d.clickEvent);return true}},hint:{config:{selector:".form-input-tip,.sparkle-hint,.sparkle-hint-has,:text[placeholder]",hasClass:"sparkle-hint-has",hintedClass:"sparkle-hint-hinted",demoText:"Simulates HTML5's <code>placeholder</code> attribute for non HTML5 browsers. Placeholder can be the <code>title</code> or <code>placeholder</code> attribute. Placeholder will not be sent with the form (unlike most other solutions). The <code>sparkle-hint</code> class is optional if you are using the <code>placeholder</code> attribute.",
