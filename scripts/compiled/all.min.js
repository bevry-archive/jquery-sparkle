...
(function(a){if(a.BalClass)console.warn("$.BalClass has already been defined...");else{a.BalClass=function(b){this.construct(b)};a.extend(a.BalClass.prototype,{config:{"default":{}},construct:function(b){this.configure(b);return true},configure:function(b){this.config=this.config||{};this.config=a.extend({},this.config,b||{});return this},addConfig:function(b,c){if(typeof c==="undefined"){if(typeof b==="object")for(var d in b)this.applyConfig(d,b[d]);return false}else typeof c==="object"&&this.applyConfig(b,
c);return this},applyConfig:function(b,c){this.config[b]=this.config[b]||{};a.extend(true,this.config[b],c||{});return this},setConfig:function(b,c){this.config[b]=c||{};return this},getConfig:function(b){if(typeof b!=="string")return this.config;return this.getConfigWith(b)},getConfigWith:function(b,c){if(typeof b!=="string"){if(typeof c==="undefined")c=b;b="default"}if(typeof c!=="object")c={};var d={};a.extend(true,d,this.config[b]||{},c||{});return d},getConfigWithDefault:function(b,c){return this.getConfigWith("default",
this.getConfigWith(b,c))}})}})(jQuery);
(function(a){if(a.Help)console.warn("$.datetimepicker has already been defined...");else{a.datetimepicker=new a.BalClass({"default":{datepickerOptions:{},timepickerOptions:{}},"12hr":{timepickerOptions:{timeConvention:12}},"24hr":{timepickerOptions:{timeConvention:24}}});a.fn.datetimepicker=function(b,c){var d=a.timepicker.getConfigWithDefault(b,c);return a(this).each(function(){var e=a(this);e.hide();if(e.hasClass("sparkle-datetime-has"))return e;e.addClass("sparkle-datetime").addClass("sparkle-datetime-has");var f=
a('<input type="text" class="sparkle-date"/>'),g=a('<span class="sparkle-datetime-sep"> @ </span>'),h=a('<input type="text" class="sparkle-time"/>'),i=e.val(),k=new Date,l="",j="";if(i){k.setDatetimestr(i);l=k.getDatestr();j=k.getTimestr()}h.insertAfter(e);g.insertAfter(e);f.insertAfter(e);f.val(l);h.val(j);f.add(h).change(function(){var m=f.val()+" "+h.val();e.val(m).trigger("change")});f.datepicker(d.datepickerOptions);h.timepicker(d.timepickerOptions);return e})}}})(jQuery);
(function(a){a(document.body).addClass("js");if(a.SparkleClass)console.warn("$.SparkleClass has already been defined...");else{a.SparkleClass=function(b){this.construct(b)};a.extend(a.SparkleClass.prototype,a.BalClass.prototype,{addExtension:function(b,c){var d=a.Sparkle;if(b==="object")for(var e in b)d.addExtension(e,b[e]);else{e={config:{},extension:false};if(typeof c==="object"&&typeof c.config!=="undefined"){e.config=c.config;e.extension=c.extension}else e.extension=c;d.addConfig(b,e)}return true},
...
(function(a){if(a.Help)console.warn("$.Bespin has already been defined...");else{a.Bespin=new a.BalClass({"default":{content:null,bespin:{settings:{tabstop:4}},toolbar:{fullscreen:true}},rich:{bespin:{syntax:"html"}},html:{bespin:{syntax:"html"}},plain:{toolbar:false}});a.Bespin.fn=function(b,c){var d=a.Bespin,e=d.getConfigWithDefault(b,c),f=this;a(window).bind("onBespinLoad",function(){d.useBespin(f,e)});window.onBespinLoad=function(){a(window).trigger("onBespinLoad")};return this};a.Bespin.useBespin=
function(b,c){var d=a.Bespin,e=a(b),f,g;if(e.is("textarea")){g=e.attr("id")+"-bespin";f=a('<div id="'+g+'"/>').html(e.val()).css({height:e.css("height"),width:e.css("width")});f.insertAfter(e);e.hide()}else{f=e;g=f.attr("id")}bespin.useBespin(g,c.bespin).then(function(h){d.postBespin(g,h,c)},function(h){throw Error("Bespin Launch Failed: "+h);});return this};a.Bespin.postBespin=function(b,c,d){b=a("#"+b);var e=b.siblings("textarea"),f=c.editor;b.css("overflow","hidden");b.wrap('<div class="bespin-wrap" />');
var g=b.parent();e.length&&e.parents("form:first").submit(function(){e.val(f.value)});if(d.content||d.content==="")f.value=d.content;if(d.toolbar){$toolbar=a('<div class="bespin-toolbar" />');$toolbar.insertBefore(b);if(d.toolbar.fullscreen){$fullscreen=a('<span class="bespin-toolbar-fullscreen">Fullscreen</span>');$fullscreen.appendTo($toolbar);$fullscreen.click(function(){g.hasClass("bespin-fullscreen")?a("body").add(g).removeClass("bespin-fullscreen"):a("body").add(g).addClass("bespin-fullscreen");
c.dimensionsChanged()})}}return this};a.fn.Bespin=function(b,c){return a.Bespin.fn.apply(this,[b,c])}}})(jQuery);
(function(a){if(a.timepicker)console.warn("$.timepicker has already been defined...");else{a.timepicker=new a.BalClass({"default":{timeConvention:24},"12hr":{timeConvention:12},"24hr":{timeConvention:24}});a.fn.timepicker=function(b,c){a.timepicker.getConfigWithDefault(b,c);return a(this).each(function(){var d=a(this);d.hide();if(d.hasClass("sparkle-time-has"))return d;d.addClass("sparkle-time").addClass("sparkle-time-has");for(var e=a('<select class="sparkle-time-hours" />'),f=12,g=1;g<=f;++g)e.append('<option value="'+
...
(function(a){if(a.Help)console.warn("$.Help has already been defined...");else{a.Help=new a.BalClass({"default":{wrap:'<span class="sparkle-help-wrap"/>',icon:'<span class="sparkle-help-icon"/>',text:'<span class="sparkle-help-text"/>',parentClass:"",title:""}});a.fn.help=function(b){var c=a.Help;if(typeof b==="string")b={title:b};b=c.getConfigWithDefault("default",b);c=a(this);var d=a(b.wrap),e=a(b.icon),f=a(b.text);c.parent().addClass(b.parentClass);var g=c.contents();c.append(d.append(f).append(e));
g.appendTo(f);c.attr("title",b.title);return c}}})(jQuery);
